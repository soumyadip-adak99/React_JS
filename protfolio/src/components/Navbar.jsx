        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center space-x-8">
                    ...
                    >
                        {isDarkMode ? <Sun size={24} /> : <Moon size={18} />}
                    </motion.button>
                </div>
                ...
                <div className="md:hidden flex items-center space-x-4">
                    <motion.button
                        ...
                        onClick={() => toggleDarkMode(isDarkMode ? "light" : "dark")}
                        className={`p-2 rounded-full transition-colors cursor-pointer
                             ${isDarkMode ? "text-gray-600 hover:text-white hover:bg-gray-800"
                                : "text-gray-600 hover:text-gray-900 hover:bg-gray-200"}`}
            ...
            <AnimatePresence>
                {isMenuOpen && (
                    <motion.div
                        ...
                        className={`md:hidden mt-4 p-4 rounded-lg  ${isDarkMode ? "border border-gray-800" : "border border-gray-200 bg-gray-200"}`}
                    >
                        {navElements.map((item) => (
                            <motion.div
                                key={item}
